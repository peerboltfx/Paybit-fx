...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <!-- Testimonials -->
    <div style='background:white;' class="slider">
       
            <div class="row">
                <div class="col-lg-12">
                    <h2 style='text-align-center;margin-top:6rem;color:black;'>News</h2>
                    <h4 style='position:relative;margin-top:6rem;left:5rem;'>Business</h4>
                </div> <!-- end of col -->
            </div> <!-- end of row -->
            <div class="row">
                <div class="col-lg-12">
                ...
                <div style='box-shadow:0px 0px 5px black;' class="slider-container">
                        <div class="swiper-container card-slider">
                           ...
                           @foreach( $post as $posts)    
                                ...
                                <div class="swiper-slide">
                                    <div class="card">
                                        <img class="card-images" src="/storage/{{  ($posts->photo)}}" alt="alternative">
                                        <a href="/News-{{  ($posts->id)}}" style="text-decoration:none;">
                                        <div class="card-body">
                                            <div class="testimonial-text" style='font-weight:700;'>{{  ($posts->post)}}</div>
                                        </div>
