...
<body data-spy="scroll" data-target=".fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    ...
                    <?php else: ?>
                    <button class="btn--outline options">
                    <a href="/register/<?php echo e(($direct)); ?>">
                        <?php echo e(('Register')); ?>
    ...
    data-aos-easing="ease-in-out">Paybit<span class="dark">FX</span></h2>
     ...
     data-aos-duration="500" class="img-fluid" src="<?php echo e(asset('./images/connect.png')); ?>" alt="alternative">
...
<h2 style='text-align:center;width:100%;'>~PaybitFX best investment company~</h2>
    ...
    <script src="../js/isotope.pkgd.min.js"></script> <!-- Isotope for filter -->
    <script src="../js/validator.min.js"></script> <!-- Validator.js - Bootstrap plugin that validates forms -->
    <script src="../js/scripts.js"></script> <!-- Custom scripts -->    <?php endif; ?>
...
</html><?php /**PATH C:\xamppp\htdocs\php\paybitFx\resources\views/welcome.blade.php ENDPATH**/ ?>